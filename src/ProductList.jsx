        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    {totalItems > 0 && <span className="cart_quantity" style={{ position: 'absolute', top: '10px', right: '10px', backgroundColor: 'red', color: 'white', borderRadius: '50%', padding: '2px 8px', fontSize: '14px' }}>{totalItems}</span>}
                    </h1></a></div>
                </div>
            </div>
            {!showCart ? (
